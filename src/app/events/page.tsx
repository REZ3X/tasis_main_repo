 ...
 * Renders the main events page with tabbed navigation between events, activities, and posters.
 * Features a hero section with animated background and responsive tab switching.
 */
